...
TODO: Da es sich um eine primäre Beinvenenthrombose handelt, sendet Frau Dr. Eva Erlenmeier vom Labor Pipette ein Feedback an Dr. Mustermann, mit der Empfehlung, ein Thrombophilie-Screening durchzuführen, welches folgende Analysen enthält:
...
Von allen drei im Blut nachgewiesenen Erreger wird ein Antibiogramm erstellt. Dabei zeigt sich, dass die beiden Wirkstoffe “Amoxicillin+Clavulansäure“ und „Ceftriaxon“ bei allen drei Keimen wirksam sind. Die Laborärztin, Frau Dr. Eva Erlenmeyer, informiert Dr. Hans Hauser regelmässig über die verschiedenen Teilresultate.
...
Die Arbeitsmedizinische Vorsorge (AMV) der SUVA, vertreten durch Dr. med. Paulo Porcellini, sendet dem Labor monatlich eine Liste mit folgenden Informationen pro Betrieb (Sammelauftrag):
