...
<!--
<p><b>author:</b> <a href=\"Organization-Labor-Pipette.html\"> The good testing laboratory</a></p>\n            
<p><b>custodian:</b> <a href=\"Organization-Labor-Pipette.html\"> The good testing laboratory</a></p>\n        
-->
</div>"
...
* category = http://terminology.hl7.org/CodeSystem/catalogType#protocol
* date = "2020-06-01T17:00:00+02:00"
* author = Reference(Organization/example-lab-organization)
* title = "The good testing laboratory - Directory of Diagnostic Services"
* custodian = Reference(Organization/example-lab-organization)
*/