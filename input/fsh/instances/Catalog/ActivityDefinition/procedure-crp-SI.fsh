...
* topic[1] = http://snomed.info/sct#55235003 "C-reactive protein measurement (procedure)"
* kind = #ServiceRequest
* code = http://loinc.org#76485-2 "C reactive protein [Moles/volume] in Serum or Plasma"
* priority = #routine
