...
* language = #en-US
* typeCollected = http://snomed.info/sct#122554006 "Capillary blood specimen (specimen)"
* collection = http://snomed.info/sct#1048003 "Capillary specimen collection (procedure)"
