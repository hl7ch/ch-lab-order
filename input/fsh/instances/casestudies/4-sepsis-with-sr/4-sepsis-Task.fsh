...
// 
* input[+].type = $sct#122555007 "Venous blood specimen (specimen)"  // In R5 Version maybe like below
// * input[+].type = $task-inputoutput#collected-specimen "Collected Specimen" // Binding: example
...
* input[+].type = $sct#119364003 "Serum specimen (specimen)" // In R5 Version maybe like below
// * input[+].type = $task-inputoutput#collected-specimen "Collected Specimen" // Binding: example
...
* output[=].valueReference = Reference(DiagnosticReport/4-sepsis-DiagnosticReportGrowth-aerobic) "CH LAB-Order 4-sepsis DiagnosticReport Growth"
