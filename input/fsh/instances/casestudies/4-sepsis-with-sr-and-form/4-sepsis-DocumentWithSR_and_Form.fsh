...
* entry[+].fullUrl = "http://example.com/fhir/Specimen/4-sepsis-Blood-bactec-plus-aerobic"  // entry[11]
* entry[=].resource = 4-sepsis-Blood-bactec-plus-aerobic
* entry[+].fullUrl = "http://example.com/fhir/Specimen/4-sepsis-Blood-bactec-plus-anaerobic"  // entry[12]
...
* entry[+].fullUrl = "http://example.com/fhir/ServiceRequest/4-sepsis-ServiceRequest"  // entry[17]
* entry[=].resource = 4-sepsis-ServiceRequest
* entry[+].fullUrl = "http://example.com/fhir/ServiceRequest/4-sepsis-ServiceRequestCBCDiff"  // entry[18]
* entry[=].resource = 4-sepsis-ServiceRequestCBCDiff
* entry[+].fullUrl = "http://example.com/fhir/ServiceRequest/4-sepsis-ServiceRequestGrowth-aerobic"  // entry[19]
* entry[=].resource = 4-sepsis-ServiceRequestGrowth-aerobic
* entry[+].fullUrl = "http://example.com/fhir/ServiceRequest/4-sepsis-ServiceRequestGrowth-anaerobic"  // entry[20]
* entry[=].resource = 4-sepsis-ServiceRequestGrowth-anaerobic
* entry[+].fullUrl = "http://example.com/fhir/ServiceRequest/4-sepsis-ServiceRequestCRP"  // entry[21]
