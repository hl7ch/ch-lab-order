...
* entry[+].fullUrl = "http://example.com/fhir/Questionnaire/0-generic-mod-Questionnaire"
* entry[=].resource = 0-generic-mod-Questionnaire
* entry[+].fullUrl = "http://example.com/fhir/QuestionnaireResponse/0-generic-mod-QuestionnaireResponse"
