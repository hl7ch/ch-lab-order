...
* entry[+].fullUrl = "http://example.com/fhir/Practitioner/EvaErlenmeyer"   // entry[7]
...
* entry[+].fullUrl = "http://example.com/fhir/ServiceRequest/service-request-potassium-serum"  // entry[13]
