Instance: 4-sepsis-QuestionnaireResponse
...
* item[=].item[=].answer.valueCoding = $lnc#90423-5 "Microorganism preliminary growth detection panel - Blood by Culture"
* item[=].item[+].linkId = "id-susc"
* item[=].item[=].text = "Bacterial Identification and Susceptibility"
* item[=].item[=].answer.valueCoding = $lnc#85421-6 "Bacterial identification and susceptibility panel - Isolate"
* item[+].linkId = "cc"
* item[=].text = "clinical chemistry"
* item[=].item.linkId = "crp"
* item[=].item.text = "CRP"
* item[=].item.answer[0].valueCoding = $lnc#1988-5 "C reactive protein [Mass/Volume] in Serum or Plasma"
* item[=].item.answer[+].valueCoding = $lnc#76485-2 "C reactive protein [Moles/volume] in Serum or Plasma"
* item[=].item.answer[+].valueCoding = $lnc#30522-7 "C reactive protein [Mass/volume] in Serum or Plasma by High sensitivity method"
* item[=].item.answer[+].valueCoding = $lnc#76486-0 "C reactive protein [Moles/volume] in Serum or Plasma by High sensitivity method"