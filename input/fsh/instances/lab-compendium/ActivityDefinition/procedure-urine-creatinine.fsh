...
Description: "Procedure Creatinine [Moles/volume] in Urine"
Usage: #example
...
// TODO adapt all items. Needs Creatinine Measurement and Creatininee Mesurment in Urine
* kind = #ServiceRequest
...
// * observationResultRequirement[+] = Reference(ObservationDefinition/observation-urine-creatinine-creatinine-ratio)