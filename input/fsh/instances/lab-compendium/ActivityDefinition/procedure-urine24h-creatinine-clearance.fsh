...
// * observationRequirement[0] = Reference(ObservationDefinition/observationCreatinineClearance)
* observationResultRequirement = Reference(ObservationDefinition/observationCreatinineClearance)
