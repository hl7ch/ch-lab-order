...
* url = "http://fhir.ch/ig/ch-lab-order/ChargeItemDefinition/example-lab-billing-vitamind-focus"
* version = "0.1.0"
...
* code = https://medcodesearch.ch/de/AL/laboratory_analyses/A#1006.00 "Vitamin D"  // needs API connection

* propertyGroup.priceComponent.type = #base
* propertyGroup.priceComponent.code = https://medcodesearch.ch/de/AL/laboratory_analyses/A#1006.00
